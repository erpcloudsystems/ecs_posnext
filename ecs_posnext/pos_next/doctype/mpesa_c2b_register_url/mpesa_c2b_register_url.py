...
from ecs_posnext.api.m_pesa import get_token
...
class MpesaC2BRegisterURL(Document):
    def validate(self):
        ...
        validation_url = (
            site_url + "/api/method/ecs_posnext.api.m_pesa.validation"
        )
        confirmation_url = (
            site_url + "/api/method/ecs_posnext.api.m_pesa.confirmation"
        )
