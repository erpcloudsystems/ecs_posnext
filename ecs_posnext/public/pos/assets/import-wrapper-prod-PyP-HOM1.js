...
(function(module, exports) {
  ((e, t) => {
      ...
      return _(_({}, k2), { transaction: function(g2, w2, e2) {
        ...
        return _(_({}, c2), { mutate: function(t2) {
          ...
          return $n(P, c2) && Qn("query", t2) ? (i3 = "immutable" === (null == (n2 = P.trans) ? void 0 : n2.db._options.cache), e2 = (n2 = P).requery, n2 = n2.signal, a2 = ((e3, t3, n3, r3) => {
            ...
            return { result: Jn(e3.result, t2, null == r2 ? void 0 : r2.optimisticOps, c2, u2, i3) };
          })) : c2.query(t2);
        } });
      } });
    } };
    ...
    }, shallowClone: G, deepClone: ee, getObjectDiff: Un, cmp: C, asap: Q, minKey: -1 / 0, addons: [], connections: { get: gn.toArray }, errnames: de, dependencies: ir, cache: Tn, semVer: "4.4.3", version: "4.4.3".split(".").map(function(e2) {
      return parseInt(e2);
