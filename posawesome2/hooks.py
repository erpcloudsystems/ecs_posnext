...
app_include_js = [
    ...
    "/assets/posawesome/js/desk_lang_toggle.js",
]
...
doctype_js = {
    ...
    "Sales Order": "public/js/sales_order_cancel.js",
    "Item": "posawesome/api/item_client_script.js",
}
...
doc_events = {
    "Sales Invoice": {
        ...
        "on_submit": "posawesome.posawesome.api.invoice.after_submit",
        "before_cancel": "posawesome.posawesome.api.invoice.before_cancel",
    },
    "Sales Order": {
        "on_submit": "posawesome.posawesome.api.order.submit",
    },
    "Customer": {
    ...
    "Payment Entry": {
        "validate": "posawesome.posawesome.api.payment_entry.validate_payment_entry",
    }
}
...
scheduler_events = {
	...
	# ],
	"daily": [
		"posawesome.posawesome.api.posapp.set_customer_favorite_items"
	],
	# "hourly": [
	...
	"cron": {
		"0 7 * * *": [
			"posawesome.posawesome.api.payments_scheduler.create_daily_payments"
		]
	}
}
...
"Sales Invoice": "posawesome.overrides.sales_invoice.SalesInvoice",
"Sales Order": "posawesome.overrides.sales_invoice.SalesOrder",
}
        ...
        "filters": [
            [
                ...
                (
                    ...
                    "POS Profile-posa_allow_sales_whole_day",
                    ...
                    "Sales Order-posa_cancellation_status",
                    "Sales Order-posa_cancellation_phone",
                    "POS Profile-posa_shift_1_start",
                    "POS Profile-posa_shift_1_end",
                    "POS Profile-posa_shift_2_start",
                    "POS Profile-posa_shift_2_end",
                ),
            ]
        ],
    },
