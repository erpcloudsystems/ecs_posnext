  ...
  methods: {
    ...
    async loadAvailableAttributes() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_item_attributes",
        });
    ...
    async loadTemplateAttributes() {
      ...
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_template_attributes",
    ...
    async addAttributeToTemplate() {
      ...
      try {
        ...
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.add_attribute_to_template",
          args: {
    ...
    async createVariantCombination() {
      ...
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.create_variant_combination",
          args: {
    ...
    async updateVariantPrice(variant) {
      ...
      try {
        await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.update_item_variant",
          args: {
    ...
    async loadCategories() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_item_groups",
        });
    ...
    async loadAvailableItems() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_items_for_bundle",
        });
    ...
    async loadProduct(itemCode) {
      ...
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_item_with_options",
    ...
    async loadVariants(itemCode) {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_item_variants",
          args: { item_code: itemCode },
        });
        if (res.message && res.message.success) {
    ...
    async removeVariant(index) {
      ...
      if (variant.isExisting && variant.item_code) {
        ...
        try {
          const res = await frappe.call({
            method:
              "posawesome.posawesome.custom_api.item_manager.delete_item_variant",
    ...
    async saveVariant(variant) {
      ...
      try {
        if (variant.isExisting && variant.item_code) {
          ...
          const res = await frappe.call({
            method:
              "posawesome.posawesome.custom_api.item_manager.create_simple_variant",
            args: {
              template_item_code: this.product.item_code,
    ...
    async createProduct() {
      ...
      if (this.product.product_type === "combo" && bundleOptions.length > 0) {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.create_bundle_item",
          args: {
            item_code: itemCode,
        ...
        const res = await frappe.call({
          method: "posawesome.posawesome.custom_api.item_manager.create_item",
          args: {
            item_code: itemCode,
            item_name: this.product.name,
            item_group: this.product.category,
    ...
    async updateProduct() {
      // Update basic info
      const res = await frappe.call({
        method: "posawesome.posawesome.custom_api.item_manager.update_item",
        args: {
          item_code: this.product.item_code,
          updates: {
            item_name: this.product.name,
      ...
      if (this.product.product_type === "combo") {
        await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.clear_bundle_options",
          args: { item_code: this.product.item_code },
        });
        ...
        for (const opt of bundleOptions) {
          await frappe.call({
            method:
              "posawesome.posawesome.custom_api.item_manager.add_bundle_option",
            args: {
              item_code: this.product.item_code,
              option: opt,
            },
