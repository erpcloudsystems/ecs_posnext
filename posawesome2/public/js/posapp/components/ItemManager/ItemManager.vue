  ...
  methods: {
    ...
    async loadItemClassifications() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_item_classifications",
        });
    ...
    async loadStockItems() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_stock_items",
        });
    ...
    async loadProductItemClassifications() {
      try {
        const res = await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.get_product_item_classifications",
        });
    ...
    async saveProductBundle() {
      if (
        ...
        await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.create_product_bundle",
          args: {
        ...
        await frappe.call({
          method:
            "posawesome.posawesome.custom_api.item_manager.delete_product_bundle",
      ...
      try {
        ...
        if (this.isEditing) {
          ...
          if (
            ...
            res = await frappe.call({
              method:
                "posawesome.posawesome.custom_api.item_manager.create_item",
              args: {
                item_code: this.currentItem.item_code,
                item_name: this.currentItem.item_name,
                item_group: this.currentItem.item_group,
